      ...
      builder: (ctx) => StatefulBuilder(builder: (ctx, setS) => AlertDialog(
        ...
        content: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          if (err != null) ...[
            ...
            Text(err!, style: const TextStyle(color: const Color(0xFFE53935), fontSize: 12)),
          ],
        ]),
        actions: [
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child: const Icon(Icons.chat_bubble_rounded, color: const Color(0xFF00D4FF), size: 36),
                ),
              ),
              ...
              if (_needsOTP) ...[
                ...
                if (_otpMessage != null)
                  Container(
                    ...
                    child: Row(children: [
                      const Icon(Icons.info_outline, color: const Color(0xFF00D4FF), size: 16),
                      const SizedBox(width: 8),
                      Expanded(child: Text(_otpMessage!,
                        style: const TextStyle(color: const Color(0xFF00D4FF), fontSize: 13))),
                    ]),
                  ),
                const SizedBox(height: 12),
                ...
                Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: Text(_error!,
                      style: const TextStyle(color: const Color(0xFFE53935), fontSize: 13))),
                  ]),
                ),
