          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                ...
                child: _selectedMedia == null ? const Icon(Icons.add_photo_alternate, color: Colors.cyanAccent, size: 40) : ClipRRect(borderRadius: BorderRadius.circular(20), child: Image.file(_selectedMedia!, fit: BoxFit.cover)),
              ),
            ),
