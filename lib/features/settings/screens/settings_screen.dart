          ...
          child: Column(
            ...
            children: error != null
                ...
                : [
                    ...
                    const SizedBox(height: 8),
                    Text('Last call push received: ' + fmt(diag['lastCallPushReceived'])),
                    const SizedBox(height: 8),
                    Text('Last call notify posted: ' + fmt(diag['lastCallNotifyPosted'])),
                    const SizedBox(height: 8),
                    Text('Token status: ' + (diag['tokenStatus']?.toString() ?? 'never')),
                    const SizedBox(height: 8),
                    Text('Token detail: ' + (diag['tokenDetail']?.toString().isEmpty ?? true ? '(none)' : diag['tokenDetail'].toString())),
                    const SizedBox(height: 8),
                    Text('Token time: ' + fmt(diag['tokenTime'])),
                  ],
          ),
        ),
        actions: [
