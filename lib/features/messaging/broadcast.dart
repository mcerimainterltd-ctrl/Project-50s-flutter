                            ...
                            child: Center(
                              child: Text('${l.members.length}',
                                  style: const TextStyle(
                                      color: const Color(0xFF00D4FF), fontSize: 15,
...
class _NewBroadcastSheetState extends State<_NewBroadcastSheet> {
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      ...
                      AnimatedContainer(
                        ...
                        width: 22, height: 22,
                        decoration: BoxDecoration(
                          color: sel ? const Color(0xFF00D4FF) : Colors.transparent,
                          border: Border.all(
                            color: sel ? const Color(0xFF00D4FF) : Colors.white24,
                            width: 1.5),
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        gradient: _sending ? null : const LinearGradient(
                          colors: [const Color(0xFF00D4FF), const Color(0xFF141420)]),
                        color: _sending ? const Color(0xFF1E1E2E) : null,
                        borderRadius: BorderRadius.circular(12),
                      ),
                      alignment: Alignment.center,
                      child: _sending
  ...
  void _snack(String msg) => ScaffoldMessenger.of(context).showSnackBar(
    SnackBar(content: Text(msg), backgroundColor: const Color(0xFF1E1E2E),
        behavior: SnackBarBehavior.floating,
        shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(12))));
