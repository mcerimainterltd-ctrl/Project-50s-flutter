    ...
    Expanded(child: TabBarView(controller: _tab, children: [
      ...
      _contactsLoaded
          ? _ContactsTab(
              ...
              onAction: (c, type) {
                if (type == 'sms') _showSms(c.primary);
                else _showPSTNConfirm(c.primary);
              })
...
class _ContactsTab extends StatelessWidget {
  ...
  final void Function(_DevContact, String) onAction;
  const _ContactsTab({required this.contacts, required this.q,
      required this.onQChange, required this.onTap, required this.onAction});
                    ...
                    child: Padding(
                      ...
                      child: Row(children: [
                        ...
                        _QuickBtn(
                          ...
                          color: _kTeal,
                          onTap: () => onAction(c, 'sms'),
                        ),
                        const SizedBox(width: 6),
                        _QuickBtn(
                          icon: Icons.call,
                          color: const Color(0xFF4CAF50),
                          onTap: () => onAction(c, 'call'),
                        ),
                      ]),
                    ));
                  cur++;
