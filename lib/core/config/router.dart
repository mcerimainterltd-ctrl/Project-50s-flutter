...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/dialpad',       builder: (c, s) => PhoneScreen(userId: user?.xameId ?? '', serverUrl: 'https://api.xamepage.com')),
      GoRoute(path: '/wallet',        builder: (c, s) => XamePayScreen(userId: user?.xameId ?? '', serverUrl: 'https://api.xamepage.com')),
